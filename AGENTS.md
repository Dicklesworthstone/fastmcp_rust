...
Toolchain: pinned `nightly-2026-08-19` (rustc 1.100.0-nightly) with workspace `rust-version = "1.100"`.
...
- **Edition:** Rust 2024 (pinned `nightly-2026-08-19` — see `rust-toolchain.toml`)
