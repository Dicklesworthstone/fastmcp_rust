...
async fn execute_positive(cx: &Cx, case: ManifestCase) {
    match case.group {
        "HTTP-03.01" => positive_01_request_construction(cx).await,
        "HTTP-03.02" => positive_02_single_post_exact_body(cx).await,
        "HTTP-03.03" => positive_03_content_type_and_accept(cx).await,
        "HTTP-03.04" => positive_04_identity_accept_encoding(cx).await,
        "HTTP-03.05" => positive_05_routing_headers(cx).await,
        "HTTP-03.06" => positive_06_json_strict_utf8(cx).await,
        "HTTP-03.07" => positive_07_response_content_type(cx).await,
        "HTTP-03.08" => positive_08_replacement_decoder_and_bom(cx).await,
        "HTTP-03.09" => positive_09_line_endings_and_data_fields(cx).await,
        "HTTP-03.10" => positive_10_comments_and_inert_fields(cx).await,
        "HTTP-03.11" => positive_11_bounds(cx).await,
        "HTTP-03.12" => positive_12_response_isolation(cx).await,
        "HTTP-03.13" => positive_13_terminal_outcome_and_progress(cx).await,
...
async fn execute_negative(cx: &Cx, case: ManifestCase) {
    match case.group {
        "HTTP-03.01" => negative_01_target_header_split(cx).await,
        "HTTP-03.02" => negative_02_non_object_params(cx).await,
        "HTTP-03.03" => negative_03_name_header_split(cx).await,
        "HTTP-03.04" => negative_04_compressed_response(cx).await,
        "HTTP-03.05" => negative_05_missing_name_mirror(cx).await,
        "HTTP-03.06" => negative_06_json_byte_order_mark(cx).await,
        "HTTP-03.07" => negative_07_wrong_charset_parameter(cx).await,
        "HTTP-03.08" => negative_08_replacement_outside_json(cx).await,
        "HTTP-03.09" => negative_09_uppercase_data_field(cx).await,
        "HTTP-03.10" => negative_10_eof_without_blank_line(cx).await,
        "HTTP-03.11" => negative_11_one_byte_over_bounds(cx).await,
        "HTTP-03.12" => negative_12_invalid_direction(cx).await,
        "HTTP-03.13" => negative_13_terminal_id_mismatch(cx).await,
