...
//! Toolchain: pinned `nightly-2026-08-25` / rustc 1.100.0-nightly
...
pub mod core {
    pub use fastmcp_core::{
        ...
        AbsoluteUriScheme, AccessToken, AdmissionPartition, AuthContext, AuthorityErrorKind,
        AuthorizationFlowQuotaKey, Budget, CANONICAL_HTTP_URL_POLICY, CANONICAL_URL_HARD_MAX_BYTES,
        CancelledError, CanonicalHttpUrl, CanonicalHttpUrlError, CanonicalResourceId,
        CanonicalResourceIdError, CanonicalResourceIdPolicy, CanonicalUrlPolicy,
        CatalogChangePublisher, ClientCapabilityInfo, ClientImplementationInfo, ClientRoot,
        CryptoInputTooLongError, Cx, DEFAULT_ABSOLUTE_URI_MAX_BYTES,
        DEFAULT_CANCELLATION_REASON_MAX_BYTES, DEFAULT_CANONICAL_URL_MAX_BYTES,
        DEFAULT_CURSOR_MAX_BYTES, DEFAULT_JSON_RPC_MAX_BODY_BYTES,
        ...
        DEFAULT_LOGICAL_EXCHANGE_MAX_WALL_CLOCK, DEFAULT_METADATA_MAX_BYTES,
        DEFAULT_METADATA_MAX_ENTRIES, DEFAULT_URI_MAX_BYTES, DISABLED_PROMPTS_KEY,
        DISABLED_RESOURCES_KEY, DISABLED_TOOLS_KEY, DefaultPortPolicy, DotSegmentPolicy,
        EPHEMERAL_KEY_MATERIAL_BYTES, ElicitationAction, ElicitationMode, ElicitationRequest,
        ElicitationResponse, ElicitationSender, EphemeralKeyMaterial, FragmentPolicy,
        ...
        HARD_URI_MAX_BYTES, HMAC_SHA256_KEY_BYTES, HMAC_SHA256_TAG_BYTES, HmacSha256Key,
        HmacSha256Tag, HmacVerificationError, IdnaPolicy, IntoOutcome, LogicalExchangeBudget,
        ...
        NotificationSender, Outcome, OutcomeExt, PROTOCOL_LIMITS_INITIAL_GENERATION,
        ParseDurationError, PercentEncodingPolicy, PreAuthSourceBucketKey, ProgressReporter,
        PromptCaller, PromptGetResult, PromptMessageItem, PromptMessageRole, ProtocolLimit,
        ProtocolLimits, ProtocolLimitsBuilder, ProtocolLimitsError, QueryPolicy, QuotaPartitionKey,
        ...
        SealedAdmissionKeyError, SecurityIdentifier, ServerCapabilityInfo, SessionState,
        Sha256Digest, SyntaxViolationPolicy, TaskId, ToolCallResult, ToolCaller, ToolContentItem,
...
pub use fastmcp_core::{
    ...
    DISABLED_PROMPTS_KEY, DISABLED_RESOURCES_KEY, DISABLED_TOOLS_KEY,
    HARD_CANCELLATION_REASON_MAX_BYTES, HARD_CURSOR_MAX_BYTES, HARD_JSON_RPC_MAX_BODY_BYTES,
    HARD_LOGICAL_EXCHANGE_MAX_INPUTS, HARD_LOGICAL_EXCHANGE_MAX_INPUTS_PER_ROUND,
    HARD_LOGICAL_EXCHANGE_MAX_ROUNDS, HARD_LOGICAL_EXCHANGE_MAX_STATE_BYTES,
    HARD_LOGICAL_EXCHANGE_MAX_WALL_CLOCK, HARD_METADATA_MAX_BYTES, HARD_METADATA_MAX_ENTRIES,
    HARD_URI_MAX_BYTES, LogicalExchangeBudget, LogicalExchangeBudgetError,
    LogicalExchangeBudgetResource, MAX_ACCESS_SCHEME_BYTES, MAX_ACCESS_TOKEN_BYTES,
    PROTOCOL_LIMITS_INITIAL_GENERATION, ParseDurationError, PreAuthSourceBucketKey, ProtocolLimit,
    ProtocolLimits, ProtocolLimitsBuilder, ProtocolLimitsError, QuotaPartitionKey,
    SealedAdmissionKeyError, SessionState, parse_duration,
};
