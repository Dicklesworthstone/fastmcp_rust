...
pub mod core {
    pub use fastmcp_core::{
        ...
        AbsoluteUriScheme, AccessToken, AdmissionController, AdmissionError, AdmissionPartition,
        AdmissionReservation, AuthContext, AuthorityErrorKind, AuthorizationFlowQuotaKey, Budget,
        ...
        DEFAULT_ABSOLUTE_URI_MAX_BYTES, DEFAULT_CANCELLATION_REASON_MAX_BYTES,
        DEFAULT_CANONICAL_URL_MAX_BYTES, DEFAULT_CURSOR_MAX_BYTES, DEFAULT_JSON_RPC_MAX_BODY_BYTES,
