...
export const McpUiToolInputNotificationSchema = z.object({
  ...
  params: z.object({
    ...
    arguments: z
      .record(z.string(), z.unknown().describe("Complete tool call arguments as key-value pairs."))
      .optional()
...
export const McpUiHostCapabilitiesSchema = z.object({
  ...
  experimental: z
    .record(
      z.string(),
      z.record(z.string(), z.any()).describe("Experimental features keyed by identifier."),
    )
    .optional()
